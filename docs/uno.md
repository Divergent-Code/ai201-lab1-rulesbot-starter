...
Reverse: Reverses the direction of play (clockwise to counter-clockwise, or vice versa). Can only be played on a matching color or another Reverse card. In a two-player game, Reverse acts like Skip.

Skip: The next player loses their turn. Can only be played on a matching color or another Skip card.

Wild: Change the current color to any color you choose, including the current color. Can be played at any time regardless of the current card. The player who plays the Wild card declares the new color.
